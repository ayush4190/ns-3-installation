...
main (int argc, char *argv[])
{
  ...
  std::string deviceName ("wlo1");
  std::string remote ("172.217.160.132"); // example.com
  ...
  device->SetAttribute ("Address", Mac48AddressValue ("F4:30:B9:AE:04:09"));
  ...
  // "1.2.3.4" string.
  //
  Ipv4Address gateway ("10.53.64.1");
